...
CREATE TABLE IF NOT EXISTS `lacrImmoBD`.`PropertiesTypes` (
  ...
  UNIQUE INDEX `idPropertiesTypes_UNIQUE` (`idPropertiesTypes` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `lacrImmoBD`.`TransactionTypes` (
  ...
  UNIQUE INDEX `idTransactionTypes_UNIQUE` (`idTransactionTypes` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `lacrImmoBD`.`TotalRooms` (
  ...
  UNIQUE INDEX `idTotalRooms_UNIQUE` (`idTotalRooms` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `lacrImmoBD`.`CommissionRates` (
  ...
  UNIQUE INDEX `idCommissionRates_UNIQUE` (`idCommissionRates` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `lacrImmoBD`.`ZipCodesAndCities` (
  ...
  INDEX `fk_ZipCodesAndCities_Regions1_idx` (`Regions_idRegions` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `lacrImmoBD`.`Address` (
  ...
  INDEX `fk_Address_ZipCodesAndCities1_idx` (`ZipCodesAndCities_idZipCodesAndCities` ASC, `ZipCodesAndCities_Regions_idRegions` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `lacrImmoBD`.`Properties` (
  ...
  UNIQUE INDEX `idOffers_UNIQUE` (`idOffers` ASC) VISIBLE,
  INDEX `fk_Properties_PropertiesTypes1_idx` (`PropertiesTypes_idPropertiesTypes` ASC) VISIBLE,
  INDEX `fk_Properties_TransactionTypes1_idx` (`TransactionTypes_idTransactionTypes` ASC) VISIBLE,
  INDEX `fk_Properties_TotalRooms1_idx` (`TotalRooms_idTotalRooms` ASC) VISIBLE,
  INDEX `fk_Properties_CommissionRates1_idx` (`CommissionRates_idCommissionRates` ASC) VISIBLE,
  INDEX `fk_Properties_Address1_idx` (`Address_idAddress` ASC, `Address_ZipCodesAndCities_idZipCodesAndCities` ASC, `Address_ZipCodesAndCities_Regions_idRegions` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `lacrImmoBD`.`Contacts` (
  ...
  UNIQUE INDEX `idContacts_UNIQUE` (`idContacts` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `lacrImmoBD`.`UsersType` (
  ...
  UNIQUE INDEX `idUsersType_UNIQUE` (`idUsersType` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `lacrImmoBD`.`Users` (
  ...
  INDEX `fk_Users_Contacts_idx` (`Contacts_idContacts` ASC) VISIBLE,
  INDEX `fk_Users_UsersType1_idx` (`UsersType_idUsersType` ASC) VISIBLE,
  INDEX `fk_Users_Address1_idx` (`Address_idAddress` ASC) VISIBLE,
...
INSERT INTO `lacrImmoBD`.`UsersType` (`idUsersType`, `userType`) VALUES (3, 'Bien');
