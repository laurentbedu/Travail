    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            if(!isset($_SESSION["connect"])) {
                echo "<div class='border p-5 rounded-lg bg-light'>Vous devez être connecté pour accéder à la liste des produits.</div>";
            } else {
            ?>
            <table class="table table-warning">
                ...
                <tr>
                    ...
                    <td class="text-center"><img class="img-thumbnail" src="src/img/<?= $data->image ?>"
                                                 alt="image du produit référencé <?= $idProduct ?>"
                                                 title="Produit référencé <?= $idProduct ?>"></td>
                    <td><?php
                        $prix = $data->price;
                    ...
                    <td>
                        <div class="row justify-content-around">
                            ...
                            if ($_SESSION["typeUtilisateur"] == 1) {
                                ?>
                                <a href="modifier.php?idProduct=<?= $idProduct ?>"
